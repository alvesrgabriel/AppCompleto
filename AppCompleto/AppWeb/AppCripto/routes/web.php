...
Route::post('/update/{id}', [CriptomoedaController::class, 'update'])->name('criptomoedas.update');
Route::get('/delete/{id}', [CriptomoedaController::class, 'destroy'])->name('criptomoedas.destroy');  